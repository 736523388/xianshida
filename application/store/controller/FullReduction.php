...
class FullReduction extends BasicAdmin
{
    /**
     * 定义当前操作表名
     * @var string
     */
    public $table = 'store_full_reduction';
    ...
    {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('store/full_reduction/index')];
